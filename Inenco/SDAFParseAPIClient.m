...
static NSString * const kSDFParseAPIApplicationId = @"aTajV1CWI5MfiM7klxYFPvUuXSaSpCSuyIZ7MCh1";
static NSString * const kSDFParseAPIKey = @"pBXlrblWohCNB4ZcjHFNIX7tZli491Z8rGDRN1wm";
...
- (AFHTTPRequestOperation *)GETRequestForAllRecordsOfClass:(NSString *)className
    ...
    if (updatedDate) {
        ...
        parameters = @{@"where" : jsonString, @"limit" : @(1000)};
    }
